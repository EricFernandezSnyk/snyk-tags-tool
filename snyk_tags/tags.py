...
from snyk_tags import __app_name__, __version__, list, collection, tag, attribute, ignore
...
app.add_typer(ignore.app, name="ignore", help="Ignore all vulnerabilities from a dependency")
